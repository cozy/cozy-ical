...
(function() {
  ...
  module.exports = function(Alarm) {
    ...
    Alarm.prototype.toIcal = function(timezone) {
      ...
      vtodo = new VTodo(date, this.id, this.description, this.details);
      vtodo.addAlarm(date);
      return vtodo;
    };
    Alarm.fromIcal = function(valarm, timezone) {
      ...
      alarm = new Alarm();
      if (valarm.fields["UID"]) {
        alarm.id = valarm.fields["UID"];
      }
      alarm.description = valarm.fields["SUMMARY"] || valarm.fields["DESCRIPTION"];
      alarm.details = valarm.fields["DESCRIPTION"] || valarm.fields["SUMMARY"];
